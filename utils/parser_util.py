...
def add_base_options(parser):
    ...
    group.add_argument("--adaln_t", type=int, default=0)
    ...
    group.add_argument("--clean", type=int, default=0)
    group.add_argument("--bps_mode", type=int, default=0)
    group.add_argument("--pointnet", type=int, default=0)
    group.add_argument("--bias", type=int, default=0)
    group.add_argument("--marker_mode", type=int, default=0)
    group.add_argument("--cid_num", type=int, default=52)
    group.add_argument("--cat", type=int, default=0)
    group.add_argument("--beta_mode", type=int, default=0)
    group.add_argument("--bone", type=int, default=0)
    group.add_argument("--snr_gamma", type=float, default=5.0)
    group.add_argument("--ome", type=float, default=1)
    group.add_argument("--version", type=int, default=5)
    
    group.add_argument("--h2o", type=int, default=1)
    group.add_argument("--use_bone", type=int, default=0)
    
    group.add_argument("--rand", type=int, default=0)
    group.add_argument("--use_aug", type=int, default=0)

    group.add_argument("--dataset", default='humanml', type=str,
                    help="Dataset name (choose from list).")
    group.add_argument("--process_v", default=1, type=int, help="Use Velocity for training")
    group.add_argument("--mean", default=0, type=int, help="Use mean")
    ...
    group.add_argument("--loss_type", default=1, type=int, help="Training Loss Type")
    ...
    group.add_argument("--handw", default=3, type=float, help="hand loss weight")
    ...
    group.add_argument("--hand_split", default=0, type=int, help="Split Hand modality")
    ...
    group.add_argument("--foot", default=14, type=int, help="")
    ...
    group.add_argument("--clean_loss", default=0, type=int, help="")
    ...
    group.add_argument("--use_gd", default=1, type=int, help="")
    ...
    group.add_argument("--vel_weight", default=0.0, type=float, help="")
    group.add_argument("--dit", default='dit', type=str, help="")
    group.add_argument("--use_beta", default=0, type=int, help="")
    group.add_argument("--rope", default=0, type=int, help="")
    group.add_argument("--learnable_pe", default=0, type=int, help="")
    ...
    group.add_argument("--use_marker", default=0, type=int, help="")
    group.add_argument("--use_rot", default=0, type=int, help="")
    group.add_argument("--use_hand_scalar_rot", default=0, type=int, help="")
    group.add_argument("--use_joint", default=0, type=int, help="")
    group.add_argument("--verts_loss", default=0, type=int, help="")
    group.add_argument("--verts_weight", default=0.5, type=float, help="")
    ...
    group.add_argument("--split_ho_emb", default=0, type=int, help="")
    group.add_argument("--split_pe", default=0, type=int, help="")
...
def add_diffusion_options(parser):
    ...
    group.add_argument("--df_prob", default=0.7, type=float, help="PROB.")
